    ...
    public static class UrlHoldUpRedirect
    {
            ...
            ILogger log)
        {
            ...
            string html =     "<html>"
                            ...
                            + "<p>The ShortLink belongs to <a href=\""+redirectUrl+"\">"+WebUtility.HtmlEncode(redirectUrl)+"</a><br />Automatic Redirect to this link at 15 Seconds.</p>"
                            + "<script>"
                            + "setTimeout(doRedir, 15000); "
