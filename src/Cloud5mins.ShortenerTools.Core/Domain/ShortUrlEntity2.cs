...
{
    public class ShortUrlEntity2: ITableEntity
    {
        ...
        public ShortUrlEntity2() { }

        public ShortUrlEntity2(string longUrl, string endUrl)
        {
            Initialize(longUrl, endUrl, string.Empty, null);
        }

        public ShortUrlEntity2(string longUrl, string endUrl, Schedule[] schedules)
        {
            Initialize(longUrl, endUrl, string.Empty, schedules);
        }

        public ShortUrlEntity2(string longUrl, string endUrl, string title, Schedule[] schedules)
        {
